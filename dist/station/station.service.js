...
let StationService = class StationService {
    ...
    async create(createStationDto) {
        return await new this.model(Object.assign(Object.assign({}, createStationDto), { createdAt: new Date() })).save();
    }
...
StationService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(station_entity_1.Station.name)),
