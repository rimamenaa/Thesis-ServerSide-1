...
let BicycleService = class BicycleService {
    ...
    async create(createBicycleDto) {
        return await new this.model(Object.assign(Object.assign({}, createBicycleDto), { createdAt: new Date() })).save();
    }
...
BicycleService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(bicycle_entity_1.Bicycle.name)),
