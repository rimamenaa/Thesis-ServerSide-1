...
let SuggestionsService = class SuggestionsService {
    ...
    async create(createSuggestionsDto) {
        return await new this.model(Object.assign(Object.assign({}, createSuggestionsDto), { createdAt: new Date() })).save();
    }
...
SuggestionsService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(suggestion_entity_1.Suggestions.name)),
